...
root.title("Message Encryption and Decryption (Raj Abhishek Maurya)")

Tops = Frame(root, width=1500, relief=SUNKEN)
Tops.pack(side=TOP)

f1 = Frame(root, width=700, relief=SUNKEN)
f1.pack(side=LEFT)
...
txtMsg = Entry(f1, font=('arial', 16, 'bold'),
               textvariable=Msg, bd=8, insertwidth=2,
...
lblkey = Label(f1, font=('arial', 14, 'bold'),
               text="KEY (Only Integer)", bd=14, anchor="w")
...
txtkey = Entry(f1, font=('arial', 16, 'bold'),
               textvariable=key, bd=8, insertwidth=2,
               bg="powder blue", justify='left')
...
txtmode = Entry(f1, font=('arial', 16, 'bold'),
                textvariable=mode, bd=8, insertwidth=2,
                bg="powder blue", justify='left')

txtmode.grid(row=3, column=1)

# labels for the result
lblResult = Label(f1, font=('arial', 14, 'bold'),
...
txtResult = Entry(f1, font=('arial', 16, 'bold'),
                  textvariable=Result, bd=8, insertwidth=2,
                  bg="powder blue", justify='left')
